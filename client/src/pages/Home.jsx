...
const Home = () => {
  ...
  return (
    <>
      ...
      {userData.sucess && (
        <div>
          <div className="welcome h-[6vh] md:j-[30vh] bg-zinc-900 text-white">
            <div className="hello flex justify-center items-start px-10 h-full w-full flex-col">
              <h1 className="text-xl jersey">Hello {userData.name} , <span className="text-green-500 tracking-wider">Let's Sneakerring</span></h1>
          ...
          <div className="popular text-white bg-zinc-900 min-h-[99vh] robot">
              ...
              {Courses.length > 0 &&
                Courses.map((item) => {
                  return (
                    <div
                      key={item._id}
                      className="course h-[38vh] w-[256px] bg-zinc-600 rounded-xl cursor-pointer overflow-hidden"
                    >
                      <div className="h-[18vh] w-full">
                        ...
                        <img
                          ...
                          alt="xyz"
                          sizes=""
                          className="h-full w-full object-cover object-contain content-center cover"
                          />
                        </div>
